...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(Emp => Emp.Job == "Frontend programmer" && Emp.Salary > 1000).OrderByDescending(Emp => Emp.Ename);
            return result;
        }
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            result = Emps.Where(Emp => Emp.Salary == maxSalary);
            return result;
        }
        ...
        {
            Emp result = null;
            result = Emps.Where(emp => emp.Job == "Frontend programmer")
        ...
        {
            IEnumerable<object> result = null;
            result = Emps.Select(emp => new { emp.Ename, emp.Job, emp.HireDate })
        ...
        {
            IEnumerable<object> result = null;
            result = Emps.GroupBy(emp => emp.Deptno)
        ...
        {
            IEnumerable<Dept> result = null;
            result = (IEnumerable<Dept>)Emps.Where(emp => emp.Job.Contains("A"))
                      .GroupBy(emp => emp.Job)
        ...
        {
            IEnumerable<Dept> result = null;
            result = (IEnumerable<Dept>)(from emp in Emps
                         from dept in Depts
                         select new { emp, dept });
            return result;
        }
